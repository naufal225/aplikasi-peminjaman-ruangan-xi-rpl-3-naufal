<x-layout-user>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-5">
            ...
            <div class="mt-2">
                <a href="{{ route('user.peminjaman.index') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                    Lihat Detail →
                </a>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div class="mt-4 flex justify-end">
                    <a href="{{ route('user.peminjaman.create') }}" class="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Pinjam
                    </a>
                </div>
            </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <a href="{{ route('user.peminjaman.create') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
                Lihat Semua Ruangan →
            </a>
        </div>
    </div>
