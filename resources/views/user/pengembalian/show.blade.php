<x-layout-user>
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('user.pengembalian.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-900">{{ $pengembalian->peminjaman->tanggal ? $pengembalian->peminjaman->tanggal->format('d M Y') : '25 Mei 2025' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-900">{{ $pengembalian->tanggal_kembali ? $pengembalian->tanggal_kembali->format('d M Y') : '25 Mei 2025' }}</p>
                    </div>
                    <div>
